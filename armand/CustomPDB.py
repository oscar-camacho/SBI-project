...
class CustomChain(Chain):      # dictionaries in utilities
    ...
    def __init__(self, chain_object):
        self.child_list = chain_object.child_list
        self._id = chain_object._id
        self.parent = chain_object.parent
        self.interactions = []  # Here there will be stored the chain's known interactions as tuple of residues
        self.xtra = chain_object.xtra
        self.level = chain_object.level
